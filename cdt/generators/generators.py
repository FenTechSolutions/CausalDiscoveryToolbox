"""Generation of data according to a graph, similar to the given observed data.
...
# ToDO : REDO properly the whole code
...
#         self.layer = th.nn.Linear(rank, 1, bias=False)
#
#     def fit(self, data):
#         return None
#
