...
class Adj_MI_fd(IndependenceModel):
    ...
    """
    def __init__(self):
        super(Adj_MI_fd, self).__init__()

    def bin_variable(self, var, bins='fd'):  # bin with normalization
    ...
    def predict_proba(self, a, b, **kwargs):
        ...
        return metrics.adjusted_mutual_info_score(self.bin_variable(a, binning_alg),
                                                  self.bin_variable(b, binning_alg))
